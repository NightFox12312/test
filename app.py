...
if __name__ == "__main__":
    ...
    def add_new_coin():
        global symbol
        # symbol = ['ALGOUSDT', 'YFIUSDT', 'DASHUSDT', 'XTZUSDT','TRXUSDT','ADAUSDT']
        symbol = ['BTCUSDT', 'ETHUSDT', 'XRPUSDT', 'LTCUSDT', 'BCHUSDT', 'ADAUSDT', 'DOTUSDT', 'LINKUSDT', 'XLMUSDT', 'BNBUSDT', 'DOGEUSDT', 'EOSUSDT', 'TRXUSDT', 'VETUSDT', 'XMRUSDT', 'NEOUSDT', 'ATOMUSDT', 'XTZUSDT', 'DASHUSDT', 'ZECUSDT', 'ETCUSDT', 'AAVEUSDT', 'UNIUSDT', 'COMPUSDT', 'SNXUSDT', 'MKRUSDT', 'YFIUSDT', 'SUSHIUSDT', 'SOLUSDT', 'AVAXUSDT', 'FTMUSDT', 'MATICUSDT', 'MANAUSDT', 'RENUSDT', 'KSMUSDT', 'ALGOUSDT', 'CHZUSDT', 'BATUSDT', 'ZRXUSDT', 'THETAUSDT', 'HOTUSDT', 'CELOUSDT', 'ENJUSDT', 'KNCUSDT']
        ## append to symbol
        new = new_coin.get()
        new = new.upper()
    ...
    root = tk.Tk()
    root.title("Binance Futures Bot (gui v1)                                                    Developed by Hai Ha")
    ...
    Live_Bot.place(relwidth=(2/4), relheight=(1/20), relx=0, rely=.95)
    ...
    Backtester.place(relwidth=(2/4), relheight=(1/20), relx=(2/4), rely=.95)
    ...
    strategy_options = ["StochRSIMACD", "tripleEMAStochasticRSIATR", "tripleEMA", "breakout", "stochBB", "goldenCross",
                        "candle_wick", "fibMACD", "EMA_cross", "heikin_ashi_ema2", "heikin_ashi_ema", "ema_crossover", "TripleScreenTradingSystem", "EnhancedTripleScreenTradingSystem", "volume_profile_order_flow_strategy"]
    strategy = StringVar()
    strategy.set("EnhancedTripleScreenTradingSystem")
    ...
    SL.insert(0, "6.18")
    TP_SL = StringVar()
    TP_SL_options = ['x Swing','en','%', 'x (ATR)', 'x (Swing High/Low) level 1', 'x (Swing Close) level 1',
